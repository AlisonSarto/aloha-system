$(document).on('click', '.delete-cargo', function() {
  ...
  $this = $(this);
  cargo = $this.parent().data('name');

  //? Tempo de espera em s
  contador = 2;

  //* Mostra modal de confirmação
  $('#modal .modal-title').html('Deletar Cargo');
  ...
  $('#modal .modal-body').html(`
    <p>
      Deseja realmente deletar o cargo <b>${cargo}</b>? <br>
      <b>Obs:</b> Os usuários que possuem esse cargo serão excluídos.
    </p>
  `);
  $('#modal').modal('show');
