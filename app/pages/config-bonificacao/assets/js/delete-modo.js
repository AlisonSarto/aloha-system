$(document).on('click', '.delete-modo', function() {
  ...
  $('#modal .modal-title').html('Deletar Modo de Produção');
  ...
  $('#modal .modal-body').html(`
    <p>
      Deseja realmente deletar esse modo? <br>
      <b>Obs:</b> As movimentações vinculadas não seram afetadas.
    </p>
  `);
  $('#modal').modal('show');
