$(document).on('click', '.delete-usuario', function() {
  ...
  $this = $(this);
  usuario = $this.parent().data('name');

  //? Tempo de espera em s
  contador = 2;

  //* Mostra modal de confirmação
  $('#modal .modal-title').html('Deletar Usuário');
  ...
  $('#modal .modal-body').html(`
    <p>
      Deseja realmente deletar o usuario <b>${usuario}</b>? <br>
      <b>Obs:</b> Após o usuário deslogar ele não conseguirá mais acessar o sistema.
    </p>
  `);
  $('#modal').modal('show');
