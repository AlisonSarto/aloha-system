$(document).on('click', '.delete-rosto', function() {

  id = $(this).parent().data('id');
  rosto = $(this).parent().data('name');

  //? Tempo de espera em s
  contador = 2;

  //* Mostra modal de confirmação
  $('#modal .modal-title').html('Deletar Rosto');
  ...
  $('#modal .modal-body').html(`
    <p>
      Deseja realmente deletar o rosto <b>${rosto}</b>? <br>
      <b>Obs:</b> Todos os registros de ponto deste rosto serão deletados.
    </p>
  `);
  $('#modal').modal('show');
