...
<head>
  ...
  <title>Rostos - Gelo System</title>
...
<body>
  ...
  <main class="container-fluid px-4">
    ...
    <h1 class="py-4 d-flex align-items-center">
      <i class="far fa-face-smile me-2"></i>
      Rostos
    </h1>

    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
      <button class="btn btn-primary mb-3" id="add-rosto"><i class="fas fa-plus"></i> Adicionar</button>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <table id="data-table" data-table="rostos"></table>
      </div>
    </div>
