...
<head>
  ...
  <title>Marcas - Gelo System</title>
...
<body>
  ...
  <main class="container-fluid px-4">
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
      <button class="btn btn-primary mb-3" id="add-marca"><i class="fas fa-plus"></i> Adicionar</button>
    </div>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <table id="data-table" data-table="marcas"></table>
      </div>
