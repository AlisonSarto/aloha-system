$(document).on('click', '.delete-marca', function() {
  ...
  $this = $(this);
  marca = $this.parent().data('name');

  //? Tempo de espera em s
  contador = 3;

  //* Mostra modal de confirmação
  $('#modal .modal-title').html('Deletar Marca');
  ...
  $('#modal .modal-body').html(`
    <p>
      Deseja realmente deletar o marca <b>${marca}</b>? <br>
      <b>Obs:</b> Os pacotes e embalagens vinculadas com essa marca tambem serão excluidas
    </p>
  `);
  $('#modal').modal('show');
